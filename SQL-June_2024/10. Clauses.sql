...
INSERT INTO sales1 (sale_id, sale_date, product_id, quantity, unit_price, customer_id) VALUES
...
GROUP BY product_id
HAVING total_sales_amount > 200
ORDER BY total_sales_amount DESC limit 2 offset 1;
...
-- 2. Example: List Products Ordered, Grouped by Product Category, 
-- with Total Quantity Sold and Total Revenue Generated, Sorted by Category ID
